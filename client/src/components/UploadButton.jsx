...
const UploadButton = ({ onClick, disabled, uploading, processing }) => {
  return (
    <button
      onClick={onClick}
      className="group w-full relative overflow-hidden px-6 py-3 bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500 text-zinc-900 dark:text-white rounded-lg font-medium transition-all shadow-lg hover:shadow-cyan-500/20 disabled:opacity-50 disabled:cursor-not-allowed disabled:shadow-none flex items-center justify-center gap-2 font-mono group/btn"
      disabled={disabled}
    >
