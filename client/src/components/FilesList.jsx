    ...
    <div className="w-full">
      ...
      {availableTags.length > 0 && (
        <div className="bg-zinc-900/50 border border-zinc-800 rounded-xl p-3 sm:p-5 mb-5">
          <div className="flex flex-col sm:flex-row sm:items-center gap-3">
            <span className="text-xs sm:text-sm font-semibold text-zinc-400 font-mono whitespace-nowrap">FILTER_BY_TAG:</span>
            <div className="flex items-center gap-2 flex-wrap">
              ...
              {(showAllTags ? availableTags : availableTags.slice(0, 3)).map((tag) => (
                <button
                  key={tag}
              ...
              {availableTags.length > 3 && (
                ...
                >
                  {showAllTags ? "Show Less" : `+${availableTags.length - 3} More`}
                </button>
              )}
            </div>
          </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-5 mb-6 sm:mb-8">
        ...
        <div className="bg-zinc-900/50 border border-zinc-800 rounded-xl p-3 sm:p-5 flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4 hover:border-white/20 transition-all hover:-translate-y-0.5">
          ...
          <div className="flex-1">
            <div className="text-xs sm:text-sm text-zinc-400 mb-1 font-mono">FOLDERS</div>
            <div className="text-xl sm:text-2xl font-bold text-zinc-100">1</div>
          </div>
        </div>
        <div className="bg-zinc-900/50 border border-zinc-800 rounded-xl p-3 sm:p-5 flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4 hover:border-white/20 transition-all hover:-translate-y-0.5">
          <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-gradient-to-br from-white to-zinc-300 flex items-center justify-center">
          ...
          <div className="flex-1">
            ...
            <div className="text-xl sm:text-2xl font-bold text-zinc-100">0</div>
          </div>
        </div>
      </div>
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div className="flex flex-col">
                          ...
                          {file.aiStatus === "completed" && file.tags && file.tags.length > 0 && (
